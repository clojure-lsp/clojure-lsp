...
| mc       | move-to-for-let              | Move expression to :let (in for or doseq) | `[file-uri,row,col,name]`                        | ✅                        | [![Screen recording of Move expression to :let](images/features/move-to-:let.gif)](images/features/move-to-:let.gif)                                         |
