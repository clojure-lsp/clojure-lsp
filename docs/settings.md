...
| `:clean`                              | Settings related to `clean-ns` refactoring.                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                      |
| `:clean :ns-inner-blocks-indentation` | Where to place first require/import, `:same-line` or `:next-line` refactoring.                                                                                                                                                                                                                                                                                                                                       | `:next-line`                                                                                                         |
