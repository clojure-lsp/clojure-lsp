...
| sc       | change-collection       | Switch collection to `{}, (), #{}, []` | `[file-uri,row,col,"map"/"list"/"set"/"vector"]` | ✅                         | <img src="../images/features/change-coll.gif" width=720> <img src="../images/features/change-coll.gif" width=720> |
