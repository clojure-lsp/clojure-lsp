...
| e2       | extract-function-2             | Extract function with selection        | `[file-uri,row,col,end-row,end-col,name]`                        | ✅                        | [![Screen recording of Extract function with selection](images/features/extract-function-sel.gif)](images/features/extract-function-sel.gif)                                     |
