...
| cf       | cycle-fn-literal        | Cycle fn literal `(fn []), #()`        | `[file-uri,row,col]`                             | ✅                        | <a href="../images/features/cycle-fn-literal.gif"><img src="../images/features/cycle-fn-literal.gif" width=480 alt="Screen recording of Cycle function literal"></a>                     |
...
| pf       | promote-fn              | Promote function `#() -> fn -> defn`   | `[file-uri,row,col]`                             | ✅                        | <a href="../images/features/promote-fn.gif"><img src="../images/features/promote-fn.gif" width=720 alt="Screen recording of Promote fn to defn"></a>                                     |
