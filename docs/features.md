...
| df       | demote-fn               | Demote `fn -> #()`                     | `[file-uri,row,col]`                             | ✅                        |                                                                                                                                                                                          |
...
| pf       | promote-fn              | Promote function `#() -> fn -> defn`   | `[file-uri,row,col,fn-name]`                     | ✅                        | <a href="../images/features/promote-fn.gif"><img src="../images/features/promote-fn.gif" width=720 alt="Screen recording of Promote fn to defn"></a>                                     |
