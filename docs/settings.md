...
| `:add-missing :add-to-rcf` | Missing libs will be added to the top of the comment form for code actions and completions from within a comment form: `[:ask\|never\|always]`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `:ask`                                                                                         |
