...
| ul       | swap-namespace-with-alias         | Change namespace to alias            | `[file-uri,row,col,ns,alias]`                    | ✅                        | [![Screen recording of Swap namespace with alias](images/features/swap-namespace-with-alias.gif)](images/features/swap-namespace-with-alias.gif)                       |
