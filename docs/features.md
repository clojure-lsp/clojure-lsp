...
| ed       | extract-definition      | Extract to def                         | `[file-uri,row,col,name]`                        | ✅                        | [![Screen recording of Extract definition](images/features/extract-definition.gif)](images/features/extract-definition.gif)                     |
