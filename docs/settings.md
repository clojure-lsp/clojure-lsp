...
| `:otlp` `:enabled`                             | Whether to enable [OpenTelemetry](https://opentelemetry.io/) integration for logs, when enabled it's require to register endpoints to where logs will be sent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `false`                                                                                       |
| `:otlp` `:config`                             | Map<string, string> following [otlp config values](https://opentelemetry.io/docs/languages/java/configuration/#properties-exporters).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `{}`                                                                                       |
