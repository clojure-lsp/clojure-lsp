...
| ul       | use-alias-suggestion         | Use alias suggestion for namespace        | `[file-uri,row,col,ns,alias]`                    | ✅                        | [![Screen recording of Use alias suggestion for namespace](images/features/use-alias-suggestion.gif)](images/features/use-alias-suggestion.gif)                       |
...
| ef       | extract-function             | Extract function                          | without selection: <br/> `[file-uri,row,col,name]` <br/>  when selection is active: <br/>`[file-uri,row,col,name,end-row,end-col]`                  | ✅                        | [![Screen recording of Extract function](images/features/extract-function.gif)](images/features/extract-function.gif) [![Screen recording of Extract function with selection](images/features/extract-function-selection.gif)](images/features/extract-function-selection.gif) [![Screen recording of Extract function for threaded operation](images/features/extract-function-threading.gif)](images/features/extract-function-threading.gif)                                     |
...
| ic       | if->cond-refactor            | Refactor if to cond                         | `[file-uri,row,col]`                             | ✅                        | [![Screen recording of refactoring if to cond](images/features/if-to-cond.gif)](images/features/if-to-cond.gif)                                                      |
| cp       | cycle-privacy                | Cycle 
...
| if       | inline-function              | Inline Function                             | `[file-uri,row,col]`                             | ✅                        | [![Screen recording of Inline function](images/features/inline-function.gif)](images/features/inline-function.gif)                                              |
...
| mc       | move-to-for-let              | Move expression to :let (in for or doseq) | `[file-uri,row,col,name]`                        | ✅                        | [![Screen recording of Move expression to :let](images/features/move-to-for-let.gif)](images/features/move-to-for-let.gif)                         |
...
| pa       | refer-to-as                  | Replace ':refer [...]' with ':as'         | `[file-uri,row,col]`                             | ✅                        |                                                                                                                                                           |
...
| pr       | as-to-refer                  | Replace ':as' with ':refer [...]'         | `[file-uri,row,col]`                             | ✅                        |                                                                                                                                                           |
