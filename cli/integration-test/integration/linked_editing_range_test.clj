...
(deftest editing-local-var
  ...
  (lsp/notify! (fixture/did-open-notification "linked_editing_shared/a.cljc"))
  (lsp/notify! (fixture/did-open-notification "linked_editing_shared/b.cljc"))
  ...
  (testing "Renaming locals"
    (h/assert-submap
      ...
      (lsp/request! (fixture/linked-editing-range-request "linked_editing_shared/a.cljc" 2 13))))

  (testing "Renaming function"
    (h/assert-submap
      {:error {:code -32602, :message "There are references on other files for this symbol"}}
      (lsp/request! (fixture/linked-editing-range-request "linked_editing_shared/a.cljc" 2 7)))))
