...
| `java` `jdk-source-download-uri`        | URI containing the JDK source to be used if `download-jdk-source?` is enabled, Check `https://github.com/clojure-lsp/jdk-source`for more sources.                                                                                                                                                                                                                                                                    | `https://raw.githubusercontent.com/clojure-lsp/jdk-source/main/openjdk-19/reduced/source.zip` |
| `java` `jdk-source-path`                | Absolute path containing the JDK source to be used instead of `jdk-source-download-uri`. Example `/usr/lib/jvm/java-17-openjdk/lib/src.zip`.
