...
| db       | drag-backward           | Drag backward                          | `[file-uri,row,col]`                             | ✅                        | <img src="../images/features/move-coll-entry.gif" width=720>         |
| df       | drag-forward            | Drag forward                           | `[file-uri,row,col]`                             | ✅                        | <img src="../images/features/move-coll-entry.gif" width=720>         |
