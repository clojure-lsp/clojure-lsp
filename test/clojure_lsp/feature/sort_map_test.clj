...
(deftest sortable-map?
  ...
  (is (not (f.sort-map/sortable-map? (z/of-string "[1 2 3 4]"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "1"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "(1 2)"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "{}"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "{:a}"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "{:a #_2 3}"))))
  (is (not (f.sort-map/sortable-map? (z/of-string "{:a 2 :b}"))))
  (is (f.sort-map/sortable-map? (z/of-string "{:a 2}")))
  (is (f.sort-map/sortable-map? (z/of-string "{:a 2 :b 3}")))
  (is (f.sort-map/sortable-map? (z/of-string "{:a {:c 4} :b 3}"))))
