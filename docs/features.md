...
| ed       | extract-definition      | Extract definition                     | `[file-uri,row,col,name]`                        | ✅                        | [![Screen recording of Extract definition](images/features/extract-definition.gif)](images/features/extract-definition.gif)                     |
